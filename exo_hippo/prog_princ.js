...
cercle1 = new Circle(new Point(5, 6), 20);
...
if(cercle1.containsPoint(point1)) console.log("Le point apprtient au cercle");
    ...
    /* console.log(`Le point est à une distance de ${Math.sqrt(Math.pow(point1.getX-cercle1.point.getX,2)+Math.pow(point1.getY-cercle1.point.getY,2))-this.radius} du cercle`); */
}